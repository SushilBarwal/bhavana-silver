...
const FAQItem = React.memo(({ faq, index, activeIndex, toggleAccordion }) => {
...
const FAQ = ({ items, title, subtitle }) => {
  const [activeIndex, setActiveIndex] = useState(0);

  // Use props or fallback to default data
  const finalItems = items && items.length > 0 ? items : faqData;
    ...
    <section id="faqs" className="py-12 bg-gray-50 sm:py-16 lg:py-20">
      <div className="max-w-screen-xl px-4 mx-auto sm:px-6 lg:px-8">
        <div className="max-w-xl mx-auto text-center">
          ...
          <p className="mt-4 text-lg text-gray-600">{finalSubtitle}</p>
        </div>
